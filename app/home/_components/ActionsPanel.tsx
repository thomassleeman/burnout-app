...
//     Object.keys(user.courses).forEach((courseSlug) => {
//       const course = user.courses[courseSlug];
//       const name = courseSlug
//         .replace(/-/g, " ")
//         .replace(/\b\w/g, (l) => l.toUpperCase()); // Capitalize words
//       const href = `/courses/${courseSlug}`;
...
//     Object.keys(user.exercises).forEach((exerciseSlug) => {
//       const exercise = user.exercises[exerciseSlug];
//       const name = exerciseSlug
//         .replace(/-/g, " ")
//         .replace(/\b\w/g, (l) => l.toUpperCase());
//       const href = `/exercises/${exerciseSlug}`;
